...
var LoginPage = /** @class */ (function () {
    function LoginPage(userData, router, api) {
...
var ApiServicesService = /** @class */ (function () {
    function ApiServicesService(http, plt) {
        this.http = http;
        this.plt = plt;
        this.httpOptions = {
    ...
    ApiServicesService.prototype._postAPI = function (methodname, params) {
        var _this = this;
        return this.http.post(this.apiUrl + methodname, params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (_) {
            return _this.log(methodname);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('login', [])));
    };
    // Calling GET Method's
    ApiServicesService.prototype._getAPI = function (methodname) {
        var _this = this;
        return this.http.get(this.apiUrl + methodname + localStorage.getItem('employeeId'), this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (_) { return _this.log(methodname); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(this.handleError('login', [])));
    };
    // Error Handling
    ApiServicesService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    ApiServicesService.prototype.log = function (message) {
        console.log(message);
    };
    ApiServicesService.ctorParameters = function () { return [
