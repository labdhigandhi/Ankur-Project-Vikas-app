...
var routes = [
    ...
    {
        path: 'account', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-account-account-module */ "pages-account-account-module").then(__webpack_require__.bind(null, /*! ./pages/account/account.module */ "./src/app/pages/account/account.module.ts")).then(function (m) { return m.AccountModule; }); }
    },
    {
        path: 'support', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-support-support-module */ "pages-support-support-module").then(__webpack_require__.bind(null, /*! ./pages/support/support.module */ "./src/app/pages/support/support.module.ts")).then(function (m) { return m.SupportModule; }); }
    },
    {
        path: 'login', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-login-login-module */ "pages-login-login-module").then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(function (m) { return m.LoginModule; }); }
    },
    {
        path: 'signup', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-signup-signup-module */ "pages-signup-signup-module").then(__webpack_require__.bind(null, /*! ./pages/signup/signup.module */ "./src/app/pages/signup/signup.module.ts")).then(function (m) { return m.SignUpModule; }); }
    },
    {
        path: 'app', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-tabs-page-tabs-page-module */ "pages-tabs-page-tabs-page-module").then(__webpack_require__.bind(null, /*! ./pages/tabs-page/tabs-page.module */ "./src/app/pages/tabs-page/tabs-page.module.ts")).then(function (m) { return m.TabsModule; }); }
    },
    {
        path: 'tutorial', loadChildren: function () { return __webpack_require__.e(/*! import() | pages-tutorial-tutorial-module */ "pages-tutorial-tutorial-module").then(__webpack_require__.bind(null, /*! ./pages/tutorial/tutorial.module */ "./src/app/pages/tutorial/tutorial.module.ts")).then(function (m) { return m.TutorialModule; }); }
    }
];
...
module.exports = ".active {\n  color: var(--ion-color-primary);\n}\n.active ion-icon {\n  color: var(--ion-color-primary);\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(events, menu, platform, router, splashScreen, statusBar, storage, userData, swUpdate, toastCtrl) {
        this.events = events;
        this.menu = menu;
        ...
        this.appPages = [
            ...
            {
                title: 'subscription',
                url: '/app/tabs/subscription',
                icon: 'information-circle'
            },
            {
                title: 'homework',
                url: '/app/tabs/homework',
                icon: 'hammer'
            }
        ];
        this.loggedIn = false;
    ...
    AppComponent.prototype.logout = function () {
        ...
        this.userData.logout().then(function () {
            return _this.router.navigateByUrl('/app/tabs/main');
        });
    };
...
module.exports = __webpack_require__(/*! /Users/kundan/Sp_Repo_Parent/sp_parent_app/src/main.ts */"./src/main.ts");
